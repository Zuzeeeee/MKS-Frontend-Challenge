...
const ProductList = () => {
  return (
    <div className={styles.container}>
      <Product onBuy={() => console.log('ola')} {...response.products[0]} />
      <Product onBuy={() => console.log('ola')} {...response.products[1]} />
      <Product onBuy={() => console.log('ola')} {...response.products[2]} />
      <Product onBuy={() => console.log('ola')} {...response.products[3]} />
      <Product onBuy={() => console.log('ola')} {...response.products[4]} />
      <Product onBuy={() => console.log('ola')} {...response.products[5]} />
      <Product onBuy={() => console.log('ola')} {...response.products[6]} />
      <Product onBuy={() => console.log('ola')} {...response.products[7]} />
    </div>
  );
};
